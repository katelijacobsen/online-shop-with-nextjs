                    ...
                    <div class="max-w-xs mx-auto">
                      ...
                      <div class="relative flex items-center">
                        ...
                        <input
                          ...
                          class="bg-gray-50 border-x-0 border-gray-300 h-8 w-8 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                          placeholder="999"
                          required
                        />
                        <button
